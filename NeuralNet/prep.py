...
for i in range(len(charged_pf_features)):
  ...
  #charged_pf_features[i] = utils.preprocess_pf_sigmoid(charged_pf_features[i], nChargedCutoff)

for i in range(len(photon_pf_features)):
  photon_pf_features[i] = utils.preprocess_pf(photon_pf_features[i], nPhotonCutoff)
  #photon_pf_features[i] = utils.preprocess_pf_sigmoid(photon_pf_features[i], nPhotonCutoff)
...
for i in range(len(neutralHad_pf_features)):
  ...
  #neutralHad_pf_features[i] = utils.preprocess_pf_sigmoid(neutralHad_pf_features[i], nNeutralHadCutoff)
