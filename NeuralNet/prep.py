...
for i in range(len(charged_pf_features)):
  charged_pf_features[i] = utils.preprocess_pf(charged_pf_features[i])

for i in range(len(photon_pf_features)):
  photon_pf_features[i] = utils.preprocess_pf(photon_pf_features[i])

for i in range(len(neutralHad_pf_features)):
  neutralHad_pf_features[i] = utils.preprocess_pf(neutralHad_pf_features[i])
