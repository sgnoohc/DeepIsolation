...
def simple(n_global_features): # for training with only global features
  ...
  deep_layer = keras.layers.Dense(200, activation = 'relu', kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), name = 'mlp_1')(input_global)
...
def parallel(charged_pf_timestep, n_charged_pf_features, photon_pf_timestep, n_photon_pf_features, neutralHad_pf_timestep, n_neutralHad_pf_features, n_global_features):
  ...
  dropout_rate = 0.15
  deep_layer_global = keras.layers.Dense(200, activation = 'relu', kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), name = 'mlp_g_1')(input_global)
  deep_layer_global = keras.layers.Dropout(dropout_rate, name = 'mlp_dropout_global_1')(deep_layer_global)
  deep_layer_global = keras.layers.Dense(100, activation = 'relu', kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), name = 'mlp_g_2')(deep_layer_global)
  deep_layer_global = keras.layers.Dropout(dropout_rate, name = 'mlp_dropout_global_2')(deep_layer_global)
  deep_layer_global = keras.layers.Dense(100, activation = 'relu', kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), name = 'mlp_g_3')(deep_layer_global)
  deep_layer_global = keras.layers.Dropout(dropout_rate, name = 'mlp_dropout_global_3')(deep_layer_global)
  deep_layer_global = keras.layers.Dense(100, activation = 'relu', kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), name = 'mlp_g_4')(deep_layer_global)
  deep_layer_global = keras.layers.Dropout(dropout_rate, name = 'mlp_dropout_global_4')(deep_layer_global)
  deep_layer_global = keras.layers.Dense(100, activation = 'relu', kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), name = 'mlp_g_5')(deep_layer_global)
  deep_layer_global = keras.layers.Dropout(dropout_rate, name = 'mlp_dropout_global_5')(deep_layer_global)
  deep_layer_global = keras.layers.Dense(100, activation = 'relu', kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), name = 'mlp_g_6')(deep_layer_global)
  deep_layer_global = keras.layers.Dropout(dropout_rate, name = 'mlp_dropout_global_6')(deep_layer_global)
  deep_layer_global = keras.layers.Dense(5, activation = 'relu', kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), name = 'mlp_g_7')(deep_layer_global)
...
def base(charged_pf_timestep, n_charged_pf_features, photon_pf_timestep, n_photon_pf_features, neutralHad_pf_timestep, n_neutralHad_pf_features, n_global_features):
  ...
  dropout_rate = 0.1
  maxnorm = 3
  conv_charged_pf = keras.layers.Convolution1D(64, 1, kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), activation = 'relu', name = 'conv_charged_pf_1')(input_charged_pf)
  conv_charged_pf = keras.layers.Dropout(dropout_rate, name = 'cpf_dropout_1')(conv_charged_pf)
  conv_charged_pf = keras.layers.Convolution1D(32, 1, kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), activation = 'relu', name = 'conv_charged_pf_2')(conv_charged_pf)
  conv_charged_pf = keras.layers.Dropout(dropout_rate, name = 'cpf_dropout_2')(conv_charged_pf)
  conv_charged_pf = keras.layers.Convolution1D(32, 1, kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), activation = 'relu', name = 'conv_charged_pf_3')(conv_charged_pf)
  conv_charged_pf = keras.layers.Dropout(dropout_rate, name = 'cpf_dropout_3')(conv_charged_pf)
  conv_charged_pf = keras.layers.Convolution1D(4, 1, kernel_initializer = 'lecun_uniform', kernel_constraint = keras.constraints.maxnorm(maxnorm), activation = 'relu', name = 'conv_charged_pf_4')(conv_charged_pf)
